...
def _qubit_term_XYZ_1(density_op: torch.tensor, qubit: int, num_qubits: int) -> torch.tensor:
    """
    ...
    output = torch.empty_like(density_op)
    output[:, 0, :, :, 0, :] = 0
...
def _qubit_term_XYZ_2(density_op: torch.tensor, qubit: int, num_qubits: int) -> torch.tensor:
    """
...
def _qubit_term_XYZ_3(density_op: torch.tensor, qubit: int, num_qubits: int) -> torch.tensor:
    """
...
def _qubit_term_PMZ_2(density_op: torch.tensor, qubit: int, num_qubits: int) -> torch.tensor:
    """
...
def _qubit_term_PMZ_3(density_op: torch.tensor, qubit: int, num_qubits: int) -> torch.tensor:
    """

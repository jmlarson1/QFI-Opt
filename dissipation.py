...
class Dissipator:
    ...
    def __init__(self, dissipation_rates: float | tuple[float, float, float], dissipation_format: str = "XYZ") -> None:
        ...
        if dissipation_format == "XYZ":
            ...
            self._rate_0 = (rate_sx + rate_sy) / 4 + rate_sz / 2
            self._rate_1 = (rate_sx + rate_sy) / 4
            self._rate_2 = (rate_sx - rate_sy) / 4
            self._qubit_term_0 = _qubit_term_XYZ_1
            self._qubit_term_1 = _qubit_term_XYZ_2
            self._qubit_term_2 = _qubit_term_XYZ_3

        elif dissipation_format == "PMZ":
            rate_sp, rate_sm, rate_sz = dissipation_rates
            self._rate_0 = sum(dissipation_rates) / 2
            self._rate_1 = rate_sp
            self._rate_2 = rate_sm
            self._qubit_term_0 = _qubit_term_PMZ_1
            self._qubit_term_1 = _qubit_term_PMZ_2
            self._qubit_term_2 = _qubit_term_PMZ_3
